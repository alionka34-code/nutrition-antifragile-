...
function LandingHeader() {
  ...
  <span className="text-marron">Le pouvoir de l'Assiette :</span> Transformez l'énergie et la performance de vos équipes</h1>
        <p className="font-SFBold text-gray-600 text-2xl md:text-4xl dark:text-gray-300">Des conférences qui transforment l'alimentation en levier stratégique de performance, pour des équipes énergisées, concentrées et engagées.</p>
