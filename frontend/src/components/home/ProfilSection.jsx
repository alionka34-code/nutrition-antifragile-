    ...
    return (
        <section className ="mt-5">
            ...
            <div className='flex flex-col mx-auto md:gap-30 justify-center md:flex-row'>
                ...
                <img src= {alionka} alt="Alionka Houl" className="mx-auto h-auto mt-4 md:w-full shadow-xl/50 rounded-lg"/>
                <h3 className="font-SFBold mt-4 text-marron text-xl md:text-2xl">Alionka</h3>
                <p className="p-4 font-SF text-lg md:text-xl border-l-4 border-marron rounded-xl shadow-lg  dark:text-white">Nutritionniste & Auteure</p>
                </div>
                ...
                <p className="text-center mt-6 mx-4 font-SF text-lg bg-degrade-marron text-white rounded-lg p-4 md:text-xl">J'ai tout quitté et je suis partie plusieurs mois dans les campagnes cambodgiennes, et me suis nourrie d'une simplicité déconcertante : riz, poisson séché, eau de coco, jus de canne, fruits gorgés de soleil. J'y ai puisé une énergie illimitée, une clarté mentale et un calme intérieur profond.</p>
                ...
                <p className="text-center mt-6 mx-4 font-SFBold text-lg rounded-lg p-4 border-2 border-marron md:text-xl  dark:text-white">Aujourd'hui, animée par une soif de vérité et de transmission, je guide chacun vers une alimentation qui nourrit le corps et l'esprit, loin des dogmes et des vices industriels.</p>
            </div>
