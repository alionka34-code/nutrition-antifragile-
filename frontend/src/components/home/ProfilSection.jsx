    ...
    return (
        <section className ="mt-20">
            ...
            <div className='flex flex-col mx-auto md:gap-30 justify-center md:flex-row'>
                ...
                <p className="text-center mt-6 mx-4 font-SF text-lg bg-gradient-to-tr from-yellow-700 to-marron text-white rounded-4xl p-4 md:text-xl">J'ai tout quitté et je suis partie plusieurs mois dans les campagnes cambodgiennes, et me suis nourrie d'une simplicité déconcertante : riz, poisson séché, eau de coco, jus de canne, fruits gorgés de soleil. J'y ai puisé une énergie illimitée, une clarté mentale et un calme intérieur profond.</p>
