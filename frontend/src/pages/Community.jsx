...
function Community() {
    return (
        ...
        <div className='text-white p-4 border-1 border-gray-300 rounded-lg bg-degrade-marron shadow-lg dark:bg-neutral-800 dark:border-neutral-500'>
            ...
            <p className='font-SF text-xl mt-8'>Tu es au bon endroit. Explore les dossiers à ton rythme, tout ce qu'il te faut est ici.<br/>
Une question ? Une adresse à partager ? Une recette ? 👉 [Rejoindre le groupe Telegram]</p>
        </div>
