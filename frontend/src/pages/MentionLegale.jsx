...
function MentionLegale() {
  ...
  <meta name="description" content="Mentions légales de Nutrition Antifragile, informations légales et contact." />
        ...
        <div className="md:mx-40 mx-4 py-8  dark:text-white">
            ...
            <p className="font-SF mb-4">Alionka HOUL (texte, œuvre, image) Artiste auteure contemporaine, scénariste, réalisatrice et écrivaine<br/>ISNI : 0000 0005 1675 5683<br/>Siège professionnel : Montpellier, France.<br/>Ce site présente les œuvres, publications et actualités professionnelles d’Alionka HOUL
           ...
           <h1 className="text-2xl font-SFBold mb-4 ">Directrice de la publication</h1>
            ...
            <p className="font-SF mb-4">Conformément aux dispositions légales et statutaires applicables, l’association Symbiose Audiovisuelle précise que :</p>
            <li className="font-SF mb-2">Les seuls statuts opposables sont ceux adoptés par l’Assemblée Générale du 19 septembre 2025.</li>
            <li className="font-SF mb-2">Toute version antérieure est réputée caduque, non opposable et sans effet juridique, et doit être retirée de toute publication ou diffusion en ligne par les tiers qui en auraient la charge.</li>
            <li className="font-SF mb-2">En cas de non-respect de cette règle statutaire, toute utilisation de versions obsolètes sera considérée comme non conforme aux statuts en vigueur et pourra engager la responsabilité de leur diffuseur.</li>
            <h1 className="text-2xl font-SFBold mb-4 ">Propriété intellectuelle</h1>
            <p className="font-SF mb-4">L’ensemble des contenus de ce site (textes, images, vidéos, extraits d’œuvres, publications) relève de la propriété exclusive de l’auteure, sauf mention contraire.<br/> Toute reproduction, représentation, adaptation ou diffusion, intégrale ou partielle, sans autorisation écrite préalable, est interdite conformément aux articles L.111-1 et s. du Code de la propriété intellectuelle.</p>
            <h1 className="text-2xl font-SFBold mb-4">Gestion, diffusion et distribution</h1>
            <p className="font-SF mb-4">La gestion administrative, la diffusion et la distribution des œuvres de l’auteure sont assurées, sous mandat exclusif, par Éditions Œuvres — Symbiose Audiovisuelle, dans le cadre de ses statuts et de ses accords de gestion des droits d’auteur.<br/><br/>
            ...
            <p className="font-SF mb-4">Le site est hébergé par Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA.<br/>Site : https://vercel.com
            </p>
            <h1 className="text-2xl font-SFBold mb-4 ">Données personnelles - RGPD</h1>
            <p className="font-SF mb-4">Aucune donnée personnelle n’est collectée sans consentement explicite.Les informations recueillies par formulaire (contact, commande, abonnement) sont destinées uniquement à la gestion des échanges et transactions.
            <br/>    
            Conformément au Règlement (UE) 2016/679 (RGPD), vous disposez d’un droit d’accès, de rectification et de suppression de vos données personnelles.Toute demande peut être adressée à : rgpd@symbiose-audiovisuelle.fr</p>
            <h1 className="text-2xl font-SFBold mb-4 ">Responsabilité</h1>
            <p className="font-SF mb-4">Les informations diffusées sur ce site sont fournies à titre informatif et artistique.L’éditeur ne saurait être tenu responsable d’erreurs, d’omissions ou de dommages directs ou indirects liés à la consultation ou à l’utilisation du site.</p>
