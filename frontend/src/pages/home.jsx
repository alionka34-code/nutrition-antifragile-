...
function Home() {
    ...
    return (
        ...
        <header className="px-4">
            ...
            <button onClick = {() => window.location.href = "https://amzn.eu/d/2ZR5MMo"} className="mt-8 block mx-auto text-lg font-SFBold rounded-full text-white px-8 py-4 bg-gradient-to-tr from-yellow-500 to-yellow-700 hover:from-yellow-600 hover:to-black transition-colors duration-300 md:text-3xl">ACHETER LE LIVRE</button>
                <button onClick={() => window.location.href="frontend/dist/assets/Extrait.pdf"} className="mt-4 block mx-auto text-lg font-SFBold rounded-full text-white px-8 py-4 bg-gradient-to-tr from-yellow-500 to-yellow-700 hover:from-yellow-600 hover:to-black transition-colors duration-300 md:text-3xl">LIRE UN EXTRAIT</button>
