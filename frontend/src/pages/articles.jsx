...
function Articles() {
  ...
  return (
    ...
    <header className=" text-center pt-10 bg-linear-to-t from-white to-gray-200">
      ...
      <p className="font-SF md:text-2xl text-lg mx-4 md:mx-auto md:max-w-5xl">Loin des fausses promesses et des étiquettes trompeuses, entrez dans le cercle de ceux qui  veulent comprendre, pas juste consommer.</p></header>
